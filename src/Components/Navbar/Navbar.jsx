        ...
        <div className="navbar bg-base-100 shadow-sm border border-gray-200">
            <div className="navbar-start">
                ...
                <div className="flex items-center gap-2">
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-linear-to-br from-red-500 to-red-600 rounded-xl flex items-center justify-center shadow-md">
            ...
            <div className="navbar-end">
                {user ? (
                    <div className="dropdown dropdown-end">
                        ...
                        <ul
                            ...
                            <li className="menu-title px-4 py-2">
                                <span className="text-xs font-semibold">{user?.displayName || user?.name || 'User'}</span>
                                <span className="text-xs text-gray-500">{user?.email}</span>
                            </li>
                            <div className="divider my-0"></div>
                            <li>
                                <Link to={getDashboardPath()} className="hover:bg-red-50">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <Link to="/login" className="btn text-white bg-linear-to-br from-red-500 to-red-600 hover:bg-red-500">
                        Login
                    </Link>
                )}
            </div>
